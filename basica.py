...
class Number:
        ...
        if isinstance(other, Number):
            if other.value == 0:
                return None, RunTimeError(
                    other.pos_start, other.pos_end, "DivideByZero Error", self.context
                )
            return Number(self.value / other.value).set_context(self.context), None
    ...
    def get_comparison_eq(self, other):
        if isinstance(other, Number):
            return (
                Number(
                    "true" if bool(self.value == other.value) else "false"
    ...
    def anded_by(self, other):
        if isinstance(other, Number):
            return (
                Number(
                    "true" if bool(self.value and other.value) else "false"
                ).set_context(self.context),
                None,
            )
    ...
    def ored_by(self, other):
        if isinstance(other, Number):
            return (
                Number(
                    "true" if bool(self.value or other.value) else "false"
                ).set_context(self.context),
                None,
            )
    ...
    def notted(self):
        return (
            Number(
                "true" if bool(1 if self.value == 0 else 0) else "false"
            ).set_context(self.context),
            None,
        )
...
global_symbol_table.set("true", Number(bool(1)))
global_symbol_table.set("false", Number(bool(0)))
